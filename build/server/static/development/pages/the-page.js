...
var _rcResizeObserver = _interopRequireDefault(__webpack_require__(/*! rc-resize-observer */ "rc-resize-observer"));
...
var _addEventListener = _interopRequireDefault(__webpack_require__(/*! rc-util/lib/Dom/addEventListener */ "rc-util/lib/Dom/addEventListener"));
...
module.exports = {
	"ant-modal": "ant-modal",
	"ant-image-preview": "ant-image-preview",
	"zoom-enter": "zoom-enter",
	"zoom-appear": "zoom-appear",
	"ant-modal-mask": "ant-modal-mask",
	"ant-image-preview-mask": "ant-image-preview-mask",
	"ant-modal-mask-hidden": "ant-modal-mask-hidden",
	"ant-image-preview-mask-hidden": "ant-image-preview-mask-hidden",
...
/* harmony import */ var _index_module_less__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index.module.less */ "./src/pages/the-page/index.module.less");
...
function TestPage(props) {
  return __jsx("div", {
    className: _index_module_less__WEBPACK_IMPORTED_MODULE_6___default.a.wrap // onClick={() => {
    //   request.get('/font/font-category/web-most-category-list/', { site_type: 'web' }).then(res => console.log(res));
    // }}

  }, __jsx(antd_lib_affix__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("nav", {
    className: _index_module_less__WEBPACK_IMPORTED_MODULE_6___default.a.nav
  }, "nav")), __jsx("div", {
    style: {
      height: '1200px'
    }
...
/* harmony reexport (default from non-harmony) */ __webpack_require__.d(__webpack_exports__, "fetch", function() { return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default.a; });
...
const baseRequest = (url, query, responseType = 'json') => {
  return new Promise(function (resolve, reject) {
    isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()(url, query).then(async response => {
...
/***/ 3:
/*!********************************************!*\
  !*** multi ./src/pages/the-page/index.jsx ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/howl/Public/workspace/personalCode/next-app-template/src/pages/the-page/index.jsx */"./src/pages/the-page/index.jsx");
